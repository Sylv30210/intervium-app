...
- **Commit / PR :** commits `e30d12d`, `e07bb1e` et `2b7a36d` poussés sur `agent/intervium-email-2026-07-18` ; le correctif d’affichage authentifié est inclus dans le commit associé à cette mise à jour ; PR [#4](https://github.com/Sylv30210/intervium-app/pull/4) ouverte sur cette branche.
